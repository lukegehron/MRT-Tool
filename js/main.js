...
document.getElementsByName("lat")[0].addEventListener('input', reload);

Lon = document.getElementById("lon").value;
document.getElementsByName("lon")[0].addEventListener('input', reload);

TimeZone = document.getElementById("tz").value;
document.getElementsByName("tz")[0].addEventListener('input', reload);

Month = document.getElementById("month").value;
document.getElementsByName("month")[0].addEventListener('input', reload);

Day = document.getElementById("day").value;
document.getElementsByName("day")[0].addEventListener('input', reload);

Hour = document.getElementById("hour").value;
document.getElementsByName("hour")[0].addEventListener('input', reload);

myNorth = document.getElementById("north").value;
document.getElementsByName("north")[0].addEventListener('input', reload);
...
document.getElementsByName("ceiling")[0].addEventListener('input', reload);

let wallLen = document.getElementById("rmLen").value;
document.getElementsByName("rmLen")[0].addEventListener('input', reload);

let wallDepVal = document.getElementById("rmDep").value;
document.getElementsByName("rmDep")[0].addEventListener('change', reload);


let windowTemp = document.getElementById("winTemp").value;
document.getElementsByName("winTemp")[0].addEventListener('input', reload);

let windowEmmis = document.getElementById("winEmmis").value;
document.getElementsByName("winEmmis")[0].addEventListener('input', reload);

let windowHeight1 = document.getElementById("windowHeight").value;
document.getElementsByName("windowHeight")[0].addEventListener('change', reload);

let windowWidth1 = document.getElementById("windowWidth").value;
document.getElementsByName("windowWidth")[0].addEventListener('change', reload);

let windowSill1 = document.getElementById("sill").value;
...
function reload(){
    ...
    // params.wall1.panel.active = true;

    // var sunGeometry1 = new THREE.SphereGeometry(0.5, 10, 10);
    // var sunMaterial1 = new THREE.MeshLambertMaterial({
    //   color: 0xff0000,
    //   opacity: 0.1,
    //   emissive: 0xffff00
    // });
    // sun1 = new THREE.Mesh(sunGeometry1, sunMaterial1);
    // scene.add(sun1);
    //
    // sun1.position.x = wallDepVal;
    // sun1.position.y = wallLen;
    // sun1.position.z = ceilingHeightValue;
  }
...
function init() {
  ...
  textMesh.rotation.z = textMesh.rotation.z + 0;
  scene.add(textMesh);
...
var sharp = solar.position(now)[0] - (180 * mrt.occupant.azimuth / Math.PI);
  if (sharp < 0) sharp += 360;
  // var my_erf = ERF(solarcal.alt, sharp, mrt.occupant.posture,
  var my_erf = ERF(solar.position(now)[1], sharp, mrt.occupant.posture,
